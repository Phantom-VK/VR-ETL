...
- Generic LLM access: set `API_KEY`, `BASE_URL`, `CHAT_MODEL` (answers, temp fixed 0.2), `REASONING_MODEL` (PageIndex search + answer reasoning, temp fixed 0.1). Requests may override models; temperatures are fixed.
